...
function AddSection() {
  ...
  const { isLoading, formRef, handleInputChange, handleSubmit } = useCreateData(
    ...
    `/api/Packages/${packageId}/sections`
  );
  ...
  return (
    <div className="p-4 max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
        <div className="p-6">
          <form ref={formRef} className="space-y-6" onSubmit={submitSection}>
            <div className="space-y-2">
              ...
              >
                <option value={0}  hidden disabled>اختر باقة</option>
                {packages.map((pkg) => (
            ...
            <div className="space-y-2">
              <label
                ...
                className="flex items-center text-sm font-bold text-gray-700"
              >
                <i className="fas fa-sliders-h text-[#6c8570] ml-2"></i>
                الحد الأقصى للإضافات
              </label>
              <div className="relative">
                <input
                type="text"
                  ...
                  onChange={handleInputChange}
                  className="w-full px-4 py-4 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-[#6c8570] focus:ring-2 focus:ring-[#bac5bb] transition-all duration-300 text-gray-900 placeholder-gray-400"
                  placeholder="أدخل الحد الأقصى للإضافات"
                />
              </div>
            </div>
